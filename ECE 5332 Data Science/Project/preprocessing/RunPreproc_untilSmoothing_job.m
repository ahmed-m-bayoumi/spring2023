...
% Edits done based on https://andysbrainbook.readthedocs.io/en/latest/SPM/SPM_Short_Course/SPM_06_Scripting.html
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.name = 'subj_xx_functionalFiles';
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {{['C:\Users\abayoumi\OneDrive - Texas Tech University\Documents\MATLAB Drive\ECE 5332 Data Science\Project\RawData\DATI\AD\subj_01\subj_01_functional.nii']}};
...
matlabbatch{4}.spm.spatial.coreg.estwrite.source = {['C:\Users\abayoumi\OneDrive - Texas Tech University\Documents\MATLAB Drive\ECE 5332 Data Science\Project\RawData\DATI\AD\subj_01\subj_01_structural.nii,1']};
