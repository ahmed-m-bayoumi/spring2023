%-----------------------------------------------------------------------
% Job saved on 18-Apr-2023 19:52:22 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
subjects = [01 04]; % Replace with a list of all of the subjects you wish to analyze
...
for subject=subjects
    ...
    matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {{['C:\Users\abayoumi\OneDrive - Texas Tech University\Documents\MATLAB Drive\ECE 5332 Data Science\Project\RawData\DATI\NCS\subj_' subject '\subj_' subject '_functional.nii']}};
    ...
    matlabbatch{4}.spm.spatial.coreg.estwrite.source = {['C:\Users\abayoumi\OneDrive - Texas Tech University\Documents\MATLAB Drive\ECE 5332 Data Science\Project\RawData\DATI\NCS\subj_' subject '\subj_' subject '_structural.nii,1']};
